...
> This post is pretty old, and I no longer use any of the tech mentioned in this post and won't recommend anyone to use. (Except Go, which I still :heart: the most, probably more :blush: )
